...
class _TrainingRemoteDataSource implements TrainingRemoteDataSource {
  ...
  Future<ApiResponse<List<TrainingRequestModel>>> getTrainingRequests({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<TrainingRequestModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'training/requests',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<TrainingRequestModel>> _value;
    try {
      _value = ApiResponse<List<TrainingRequestModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<TrainingRequestModel>(
                    (i) => TrainingRequestModel.fromJson(
                      i as Map<String, dynamic>,
                    ),
                  )
                  .toList()
