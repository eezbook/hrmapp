...
class _AuthRemoteDataSource implements AuthRemoteDataSource {
  ...
  Future<ApiResponse<AuthResponseModel>> login(
    ...
    _data.addAll(body);
    final _options = _setStreamType<ApiResponse<AuthResponseModel>>(
  ...
  @override
  Future<ApiResponse<EmployeeModel>> getMe() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<EmployeeModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<EmployeeModel> _value;
    try {
      _value = ApiResponse<EmployeeModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<void>> verifyOtp(Map<String, String> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> resetPassword(Map<String, String> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> updateDeviceToken(Map<String, String> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
